...
console.log(addArtist(20, "Cameron Garner", "1998 - 2020", "web design", "American", "Cameron Garner, the ultimate programmer and lover of dogs."))
...
function lotsOfArt(arr){
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].paintings >= 100) {
      return numberof.push(arr[i].name)
    }
  }
